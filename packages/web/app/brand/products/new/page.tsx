...
import { Package, ArrowLeft, Save, Upload, X, ImageIcon, Clock } from 'lucide-react'
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">Product will go to admin review before going live</p>
            </div>
          ...
          <Card variant="elevated">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="p-4 bg-amber-50 border border-amber-200 rounded-lg flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-amber-800">Pending Admin Review</p>
                  <p className="text-xs text-amber-700 mt-0.5">New products are reviewed before being made visible to influencers. You&apos;ll see the status in your products list.</p>
                </div>
              </div>
